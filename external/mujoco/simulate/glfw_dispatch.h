...
#define mjGLFW_DECLARE_SYMBOL(func) decltype(&::func) func
  ...
  mjGLFW_DECLARE_SYMBOL(glfwSetWindowCloseCallback);
  ...
  mjGLFW_DECLARE_SYMBOL(glfwRestoreWindow);
  mjGLFW_DECLARE_SYMBOL(glfwMaximizeWindow);
  mjGLFW_DECLARE_SYMBOL(glfwDestroyWindow);
  mjGLFW_DECLARE_SYMBOL(glfwSetWindowShouldClose);
  // go/keep-sorted end
